...
bot.on("message", async (msg) => {
  ...
  // Buscar o crear el contacto
    ...
    const msgReceived = await newMsgReceived(chatId, msg.from.id, message, senderName, timestamp,  chatId,  businessId, "No Leidos", true, null, false, newContact, socialMediaId)
    console.log("PREGUNTA-TELEGRAM(BOT): Mensaje recibido guardado en la base de datos:", msgReceived);
